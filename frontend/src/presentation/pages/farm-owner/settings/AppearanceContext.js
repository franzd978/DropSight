...
const FarmAppearanceContext = createContext();
const colorOptions = ["#FFFFFF", "#EF6068", "#F5CB5C", "#2D4746"];

const FarmAppearanceProvider = ({ children }) => {
  ...
  return (
    <FarmAppearanceContext.Provider
      value={{
        theme,
        setTheme,
        primaryColor,
...
export { FarmAppearanceContext, FarmAppearanceProvider };
